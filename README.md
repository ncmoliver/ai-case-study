...
Offering a product/service that could visually show the different possibilities of future player movement would be next level in the game of basketball. As we know basketball has a natural flow that must occur, when one team does not have the ball, other team has the basketball. If a team is not on offense they are on defense. When the basketball is in play it is in either 1 of four different parts of the game, which are dictated by the way the defense attempts to guard the basketball. The fours parts are Set, Transiton, Zone, or Press. Coaches with the knowledge at their hands to predict what will happen next can proactively create measure to either face or avoid the roadblock.     
